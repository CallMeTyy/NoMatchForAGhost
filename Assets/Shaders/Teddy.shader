...
Shader "Teddy"
{
	Properties
	{
		...
		[ASEBegin][HDR]_FresnelColorFar("Fresnel Color Far", Color) = (0,0.8537688,1,0)
		[HDR]_FresnelColorNear("Fresnel Color Near", Color) = (0,1,0.01982021,0)
		_TargetPosition("TargetPosition", Vector) = (-27,0,-2.5,0)
		[ASEEnd]_Distance("Distance", Float) = 9.25
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _FresnelColorFar;
			float4 _FresnelColorNear;
						 ...
						 ) : SV_Target
			{
				...
				float2 coords18 = IN.ase_texcoord8.xy * 9.58;
				float2 id18 = 0;
				float2 uv18 = 0;
				float fade18 = 0.5;
				float voroi18 = 0;
				float rest18 = 0;
				for( int it18 = 0; it18 <2; it18++ ){
				voroi18 += fade18 * voronoi18( coords18, time18, id18, uv18, 0,voronoiSmoothId18 );
				rest18 += fade18;
				coords18 *= 2;
				fade18 *= 0.5;
				}//Voronoi18
				...
				float fresnelNode13 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV13, ( ( voroi18 * 10.8 ) + 5.0 ) ) );
				float temp_output_22_0 = ( fresnelNode13 * (0.2 + (_TimeParameters.y - -1.0) * (1.0 - 0.2) / (1.0 - -1.0)) );
				float4 temp_output_15_0 = ( temp_output_22_0 * _FresnelColorFar );
				float4 lerpResult25 = lerp( temp_output_15_0 , ( temp_output_22_0 * _FresnelColorNear ) , saturate( (0.0 + (distance( WorldPosition , _TargetPosition ) - 0.0) * (1.0 - 0.0) / (_Distance - 0.0)) ));
				float4 color11 = IsGammaSpace() ? float4(0.4039216,0.2862745,0.1764706,1) : float4(0.1356334,0.06662594,0.02624122,1);
				
				float3 Albedo = ( lerpResult25 + color11 ).rgb;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float time18 = _TimeParameters.x;
				float2 voronoiSmoothId18 = 0;
				float2 coords18 = IN.ase_texcoord5.xy * 9.58;
				float2 id18 = 0;
				float2 uv18 = 0;
				float fade18 = 0.5;
				float voroi18 = 0;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float time18 = _TimeParameters.x;
				float2 voronoiSmoothId18 = 0;
				float2 coords18 = IN.ase_texcoord3.xy * 9.58;
				float2 id18 = 0;
				float2 uv18 = 0;
				float fade18 = 0.5;
				float voroi18 = 0;
...
/*ASEBEGIN
Version=18935
31.33333;242.6667;1693.333;849;1150.326;1166.079;1.620318;True;True
Node;AmplifyShaderEditor.RangedFloatNode;10;-257.6669,160.1667;Inherit;False;Constant;_Float0;Float 0;0;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SinTimeNode;23;-901.2073,-723.011;Inherit;True;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;14;-93.66687,-70.83333;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;22;-450.5634,-583.7606;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-354.4222,-313.6966;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.TFHCRemapNode;31;392.8646,-716.5991;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;11;-507.7664,26.89286;Inherit;False;Constant;_Color0;Color 0;0;0;Create;True;0;0;0;False;0;False;0.4039216,0.2862745,0.1764706,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector3Node;30;-321.0472,-734.869;Inherit;False;Property;_TargetPosition;TargetPosition;2;0;Create;True;0;0;0;False;0;False;-27,0,-2.5;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.LerpOp;25;793.2242,-496.5005;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;17;-679.6669,-244.8333;Inherit;False;Property;_FresnelColorFar;Fresnel Color Far;0;1;[HDR];Create;True;0;0;0;False;0;False;0,0.8537688,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;27;-708.3582,-70.60971;Inherit;False;Property;_FresnelColorNear;Fresnel Color Near;1;1;[HDR];Create;True;0;0;0;False;0;False;0,1,0.01982021,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;33;614.3627,-639.8663;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;-962.8064,-239.2662;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;10.8;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;24;-685.205,-667.0917;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;-1;False;2;FLOAT;1;False;3;FLOAT;0.2;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.DistanceOpNode;28;22.4236,-645.3473;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;29;-332.5151,-914.9717;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;32;91.84863,-818.9096;Inherit;False;Property;_Distance;Distance;3;0;Create;True;0;0;0;False;0;False;9.25;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FresnelNode;13;-699.6669,-481.8333;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;21;-1392.806,-287.2662;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;26;-267.0631,-534.8094;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;19;-847.8064,-337.2662;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.VoronoiNode;18;-1166.806,-355.2662;Inherit;False;0;0;1;0;2;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;9.58;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
...
ASEEND*/
//CHKSM=D7E921F35CE2F9E17BEA2475286429A3E29FEE67
...
Shader "Fire Base"
{
	Properties
	{
		...
		[ASEBegin]_EmissionPower("Emission Power", Float) = 0
		[ASEEnd]_AlphaPower("Alpha Power", Float) = 1.4
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 color41 = IsGammaSpace() ? float4(1,0.3501132,0,0) : float4(1,0.1005489,0,0);
				float4 color43 = IsGammaSpace() ? float4(1,0.5459422,0.1383647,0) : float4(1,0.2590553,0.01704116,0);
				float time49 = 0.0;
				float2 voronoiSmoothId49 = 0;
				float2 texCoord47_g5 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 center45_g5 = float2( 0.5,0.5 );
				float2 delta6_g5 = ( texCoord47_g5 - center45_g5 );
				float angle10_g5 = ( length( delta6_g5 ) * 2.73 );
				float x23_g5 = ( ( cos( angle10_g5 ) * delta6_g5.x ) - ( sin( angle10_g5 ) * delta6_g5.y ) );
				float2 break40_g5 = center45_g5;
				float mulTime54 = _TimeParameters.x * 0.4;
				float2 temp_cast_0 = (mulTime54).xx;
				float2 break41_g5 = temp_cast_0;
				...
				float2 temp_output_51_0 = appendResult44_g5;
				float2 coords49 = temp_output_51_0 * 3.97;
				float2 id49 = 0;
				float2 uv49 = 0;
				float fade49 = 0.5;
				float voroi49 = 0;
				float rest49 = 0;
				for( int it49 = 0; it49 <2; it49++ ){
				voroi49 += fade49 * voronoi49( coords49, time49, id49, uv49, 0,voronoiSmoothId49 );
				rest49 += fade49;
				coords49 *= 2;
				fade49 *= 0.5;
				}//Voronoi49
				voroi49 /= rest49;
				float4 lerpResult48 = lerp( color41 , color43 , voroi49);
				float div60=256.0/float(14);
				float4 posterize60 = ( floor( lerpResult48 * div60 ) / div60 );
				
				float time50 = 0.0;
				float2 voronoiSmoothId50 = 0;
				float2 coords50 = temp_output_51_0 * 3.25;
				float2 id50 = 0;
				float2 uv50 = 0;
				float fade50 = 0.5;
				float voroi50 = 0;
				...
				voroi50 /= rest50;
				float saferPower57 = abs( voroi50 );
				float4 temp_cast_3 = (pow( saferPower57 , _AlphaPower )).xxxx;
				float div56=256.0/float(16);
				float4 posterize56 = ( floor( temp_cast_3 * div56 ) / div56 );
				
				float3 Albedo = posterize60.rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( posterize60 * _EmissionPower ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = 0.0;
				float Occlusion = 1;
				float Alpha = posterize56.r;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float time50 = 0.0;
				float2 voronoiSmoothId50 = 0;
				float2 texCoord47_g5 = IN.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 center45_g5 = float2( 0.5,0.5 );
				float2 delta6_g5 = ( texCoord47_g5 - center45_g5 );
				float angle10_g5 = ( length( delta6_g5 ) * 2.73 );
				float x23_g5 = ( ( cos( angle10_g5 ) * delta6_g5.x ) - ( sin( angle10_g5 ) * delta6_g5.y ) );
				...
				voroi50 /= rest50;
				float saferPower57 = abs( voroi50 );
				float4 temp_cast_1 = (pow( saferPower57 , _AlphaPower )).xxxx;
				float div56=256.0/float(16);
				float4 posterize56 = ( floor( temp_cast_1 * div56 ) / div56 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float time49 = 0.0;
				float2 voronoiSmoothId49 = 0;
				float2 texCoord47_g5 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float2 center45_g5 = float2( 0.5,0.5 );
				float2 delta6_g5 = ( texCoord47_g5 - center45_g5 );
				float angle10_g5 = ( length( delta6_g5 ) * 2.73 );
				float x23_g5 = ( ( cos( angle10_g5 ) * delta6_g5.x ) - ( sin( angle10_g5 ) * delta6_g5.y ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				voroi50 /= rest50;
				float saferPower57 = abs( voroi50 );
				float4 temp_cast_2 = (pow( saferPower57 , _AlphaPower )).xxxx;
				float div56=256.0/float(16);
				float4 posterize56 = ( floor( temp_cast_2 * div56 ) / div56 );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float time50 = 0.0;
				float2 voronoiSmoothId50 = 0;
				float2 texCoord47_g5 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 center45_g5 = float2( 0.5,0.5 );
				float2 delta6_g5 = ( texCoord47_g5 - center45_g5 );
				float angle10_g5 = ( length( delta6_g5 ) * 2.73 );
				float x23_g5 = ( ( cos( angle10_g5 ) * delta6_g5.x ) - ( sin( angle10_g5 ) * delta6_g5.y ) );
				...
				surfaceDescription.Alpha = posterize56.r;
...
/*ASEBEGIN
Version=18935
104;236;1693.333;891;779.4857;361.019;1.692783;True;True
Node;AmplifyShaderEditor.RangedFloatNode;52;-200.7561,-40.3629;Inherit;False;Constant;_Float1;Float 1;0;0;Create;True;0;0;0;False;0;False;2.73;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;54;-229.7561,73.63715;Inherit;False;1;0;FLOAT;0.4;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;51;-35.75607,-28.3629;Inherit;False;Twirl;-1;;5;90936742ac32db8449cd21ab6dd337c8;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT;0;False;4;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.VoronoiNode;50;220.6294,-96.29689;Inherit;True;0;0;1;0;2;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;3.25;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.RangedFloatNode;62;170.1655,207.1918;Inherit;False;Property;_AlphaPower;Alpha Power;1;0;Create;True;0;0;0;False;0;False;1.4;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;57;486.6454,19.41443;Inherit;True;True;2;0;FLOAT;0;False;1;FLOAT;1.3;False;1;FLOAT;0
Node;AmplifyShaderEditor.BillboardNode;61;1040.527,238.1144;Inherit;False;Spherical;True;True;0;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;59;523.4257,-248.5756;Inherit;False;Property;_EmissionPower;Emission Power;0;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PosterizeNode;56;770.8792,27.41663;Inherit;True;16;2;1;COLOR;0,0,0,0;False;0;INT;16;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;37;5.504813,278.96;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;58;744.2258,-258.1757;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.PosterizeNode;60;533.3148,-473.9031;Inherit;True;14;2;1;COLOR;0,0,0,0;False;0;INT;14;False;1;COLOR;0
Node;AmplifyShaderEditor.DynamicAppendNode;39;325.0348,268.91;Inherit;False;FLOAT3;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;42;291.2651,-198.6301;Inherit;False;Constant;_Float2;Float 2;1;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;43;-336.6465,-474.2549;Inherit;False;Constant;_Color1;Color 1;1;0;Create;True;0;0;0;False;0;False;1,0.5459422,0.1383647,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PosVertexDataNode;35;-289.4951,482.07;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VoronoiNode;38;-291.6252,212.55;Inherit;True;0;0;1;0;2;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;7.05;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.ColorNode;41;-340.2136,-656.9185;Inherit;False;Constant;_Color0;Color 0;1;0;Create;True;0;0;0;False;0;False;1,0.3501132,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VoronoiNode;49;-62.2052,-307.5872;Inherit;True;0;0;1;0;2;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;3.97;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.LerpOp;48;214.496,-554.4277;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;1264.594,-129.416;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;2;Fire Base;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;19;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;40;Workflow;1;637949483199671257;Surface;1;637949483210801381;  Refraction Model;0;0;  Blend;0;0;Two Sided;0;637949491517235972;Fragment Normal Space,InvertActionOnDeselection;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,-1;0;Translucency;0;0;  Translucency Strength;1,False,-1;0;  Normal Distortion;0.5,False,-1;0;  Scattering;2,False,-1;0;  Direct;0.9,False,-1;0;  Ambient;0.1,False,-1;0;  Shadow;0.5,False,-1;0;Cast Shadows;0;637949494752704995;  Use Shadow Threshold;0;0;Receive Shadows;0;637949494761197468;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;False;True;True;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=7FDE757F0054F19C885F622365FC29284B7F48AF
...
Shader "Fire"
{
	Properties
	{
		...
		_StutterSpeed("Stutter Speed", Float) = 1.09
		_Spec("Spec", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord9 = IN.ase_texcoord8.xy * _NoiseScale + appendResult18;
				float simpleNoise8 = SimpleNoise( texCoord9*19.7 );
				float2 appendResult27 = (float2(0.0 , ( IN.ase_texcoord8.y * ( _DistortionStrength * ( simpleNoise8 - 0.5 ) ) )));
				float2 texCoord26 = IN.ase_texcoord8.xy * appendResult28 + appendResult27;
				...
				float2 appendResult11_g3 = (float2(0.5 , 0.7));
				float temp_output_17_0_g3 = length( ( (appendResult35*2.0 + -1.0) / appendResult11_g3 ) );
				...
				float4 temp_output_42_0 = ( _Color * ( saturate( ( ( 1.0 - temp_output_17_0_g3 ) / fwidth( temp_output_17_0_g3 ) ) ) + posterize41 ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 appendResult18 = (float2(( saturate( ase_screenPosNorm.x ) * 5.0 ) , -( _TimeParameters.x * _Speed )));
				float2 texCoord9 = IN.ase_texcoord4.xy * _NoiseScale + appendResult18;
				float simpleNoise8 = SimpleNoise( texCoord9*19.7 );
				float2 appendResult27 = (float2(0.0 , ( IN.ase_texcoord4.y * ( _DistortionStrength * ( simpleNoise8 - 0.5 ) ) )));
				float2 texCoord26 = IN.ase_texcoord4.xy * appendResult28 + appendResult27;
				float clampResult51 = clamp( ( saturate( ( 1.0 - texCoord26.y ) ) + _FlameAmount ) , 0.0 , 1.0 );
				float temp_output_33_0 = pow( clampResult51 , 2.0 );
				float2 appendResult35 = (float2(texCoord26.x , ( 1.0 - temp_output_33_0 )));
				float2 appendResult11_g3 = (float2(0.5 , 0.7));
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 appendResult18 = (float2(( saturate( ase_screenPosNorm.x ) * 5.0 ) , -( _TimeParameters.x * _Speed )));
				float2 texCoord9 = IN.ase_texcoord.xy * _NoiseScale + appendResult18;
				float simpleNoise8 = SimpleNoise( texCoord9*19.7 );
				float2 appendResult27 = (float2(0.0 , ( IN.ase_texcoord.y * ( _DistortionStrength * ( simpleNoise8 - 0.5 ) ) )));
				float2 texCoord26 = IN.ase_texcoord.xy * appendResult28 + appendResult27;
				float clampResult51 = clamp( ( saturate( ( 1.0 - texCoord26.y ) ) + _FlameAmount ) , 0.0 , 1.0 );
				float temp_output_33_0 = pow( clampResult51 , 2.0 );
				float2 appendResult35 = (float2(texCoord26.x , ( 1.0 - temp_output_33_0 )));
				float2 appendResult11_g2 = (float2(1.0 , 1.0));
				...
				surfaceDescription.Alpha = ifLocalVar70;
...
/*ASEBEGIN
Version=18935
124;368.6667;1693.333;873;-3890.458;-36.10401;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;50;1354.505,494.6756;Inherit;False;Property;_FlameAmount;Flame Amount;6;0;Create;True;0;0;0;False;0;False;0;-1;-1;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;74;2693.016,742.8134;Inherit;False;Property;_StutterSpeed;Stutter Speed;9;0;Create;True;0;0;0;False;0;False;1.09;1.09;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;88;4381.18,218.7526;Inherit;False;Property;_Smoothness;Smoothness;11;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;36;2596.424,25.62644;Inherit;True;Ellipse;-1;;3;3ba94b7b3cfd5f447befde8107c04d52;0;3;2;FLOAT2;0,0;False;7;FLOAT;0.5;False;9;FLOAT;0.7;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;87;4347.42,149.4483;Inherit;False;Property;_Spec;Spec;10;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;86;4130.417,251.3056;Inherit;False;Constant;_Float2;Float 2;10;0;Create;True;0;0;0;False;0;False;0.95;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;84;4337.453,162.4716;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;2;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;True;4;d3d11;glcore;gles;gles3;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;85;4337.453,162.4716;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;2;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;True;4;d3d11;glcore;gles;gles3;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;4957.861,94.8801;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;2;Fire;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;19;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;40;Workflow;0;0;Surface;0;637949455859143232;  Refraction Model;0;0;  Blend;0;0;Two Sided;0;637949456150164478;Fragment Normal Space,InvertActionOnDeselection;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,-1;0;Translucency;0;0;  Translucency Strength;1,False,-1;0;  Normal Distortion;0.5,False,-1;0;  Scattering;2,False,-1;0;  Direct;0.9,False,-1;0;  Ambient;0.1,False,-1;0;  Shadow;0.5,False,-1;0;Cast Shadows;0;637949494928372025;  Use Shadow Threshold;0;0;Receive Shadows;0;637949494936585447;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;637949542559157585;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;4,False,-1;637949541603655861;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;False;True;True;True;True;True;True;True;False;;False;0
...
WireConnection;1;7;86;0
ASEEND*/
//CHKSM=9C42258B298C2346EE94FCF8342ECDB94F8DB03A
...
Shader "Television"
{
	Properties
	{
		...
		_Frequency("Frequency", Float) = 16.55
		_Thickness("Thickness", Float) = 16.55
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float cos10_g1 = cos( radians( 87.94 ) );
				float sin10_g1 = sin( radians( 87.94 ) );
				float2 rotator10_g1 = mul( IN.ase_texcoord8.xy - float2( 0.5,0.5 ) , float2x2( cos10_g1 , -sin10_g1 , sin10_g1 , cos10_g1 )) + float2( 0.5,0.5 );
				float2 appendResult8_g1 = (float2(_Frequency , 1.0));
				float time12 = 0.0;
				float2 voronoiSmoothId12 = 0;
				float2 temp_cast_0 = (( _TimeParameters.x * _Speed )).xx;
				float2 texCoord14 = IN.ase_texcoord8.xy * float2( 1,1 ) + temp_cast_0;
				float2 coords12 = texCoord14 * _VoronoiScale;
				float2 id12 = 0;
				float2 uv12 = 0;
				float fade12 = 0.5;
				float voroi12 = 0;
				float rest12 = 0;
				for( int it12 = 0; it12 <2; it12++ ){
				...
				voroi12 /= rest12;
				float2 appendResult9_g1 = (float2(voroi12 , 0.0));
				float2 appendResult10_g2 = (float2(_Thickness , 1.0));
				...
				float4 lerpResult16 = lerp( _Color1 , _Color2 , saturate( min( break16_g2.x , break16_g2.y ) ));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float cos10_g1 = cos( radians( 87.94 ) );
				float sin10_g1 = sin( radians( 87.94 ) );
				float2 rotator10_g1 = mul( IN.ase_texcoord4.xy - float2( 0.5,0.5 ) , float2x2( cos10_g1 , -sin10_g1 , sin10_g1 , cos10_g1 )) + float2( 0.5,0.5 );
				float2 appendResult8_g1 = (float2(_Frequency , 1.0));
				float time12 = 0.0;
				float2 voronoiSmoothId12 = 0;
				float2 temp_cast_0 = (( _TimeParameters.x * _Speed )).xx;
				float2 texCoord14 = IN.ase_texcoord4.xy * float2( 1,1 ) + temp_cast_0;
				float2 coords12 = texCoord14 * _VoronoiScale;
				float2 id12 = 0;
				float2 uv12 = 0;
				float fade12 = 0.5;
...
/*ASEBEGIN
Version=18935
33.33334;888.6667;1693.333;855;1766.667;182.5001;1;True;True
Node;AmplifyShaderEditor.FunctionNode;10;-534.6667,45.16666;Inherit;True;Stripes;-1;;1;8e73a71cdf24db740864b4c3f3357e7f;0;4;5;FLOAT;6;False;4;FLOAT;0;False;3;FLOAT;0.5;False;12;FLOAT;87.94;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;17;-491.6667,-312.8333;Inherit;False;Property;_Color1;Color 1;0;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VoronoiNode;12;-806.6667,1.166656;Inherit;False;0;0;1;2;2;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;6.8;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.TextureCoordinatesNode;14;-1055.667,-28.83334;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleTimeNode;13;-1343.667,99.16666;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;24;-1344.667,283.1666;Inherit;False;Property;_Speed;Speed;5;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;18;-496.6667,-137.8333;Inherit;False;Property;_Color2;Color 2;1;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;21;-773.6667,155.1666;Inherit;False;Property;_Thickness;Thickness;3;0;Create;True;0;0;0;False;0;False;16.55;1.37;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-772.6667,-128.8333;Inherit;False;Property;_Frequency;Frequency;2;0;Create;True;0;0;0;False;0;False;16.55;1.37;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;22;-977.6667,134.1667;Inherit;False;Property;_VoronoiScale;Voronoi Scale;4;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;23;-1179.667,153.1666;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;16;-193.6667,-20.83334;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=B26C5683E8B0C2515F399456D4F105C362DB7A6B
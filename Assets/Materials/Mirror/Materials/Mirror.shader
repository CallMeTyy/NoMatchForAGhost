...
Shader "Mirror"
{
	Properties
	{
		...
		[ASEBegin][HDR]_TextureSample0("Texture Sample 0", 2D) = "white" {}
		_Metallic("Metallic", Float) = 0
		[ASEEnd]_EmissionPower("Emission Power", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord15 = IN.ase_texcoord8.xy * float2( 2,1 ) + float2( 0,0 );
				float2 coords18 = texCoord15 * 13.41;
				float2 id18 = 0;
				float2 uv18 = 0;
				float fade18 = 0.5;
				float voroi18 = 0;
				float rest18 = 0;
				for( int it18 = 0; it18 <3; it18++ ){
				...
				voroi18 /= rest18;
				float temp_output_30_0 = ( voroi18 * 0.2 );
				...
				float simplePerlin2D14 = snoise( texCoord15 );
				simplePerlin2D14 = simplePerlin2D14*0.5 + 0.5;
				float temp_output_20_0 = ( pow( simplePerlin2D14 , 0.05 ) + -0.05 );
				float4 lerpResult17 = lerp( temp_cast_0 , tex2D( _TextureSample0, uv_TextureSample0 ) , saturate( temp_output_20_0 ));
				float time23 = 0.0;
				float2 voronoiSmoothId23 = 0;
				float2 coords23 = texCoord15 * 38.81;
				float2 id23 = 0;
				float2 uv23 = 0;
				float fade23 = 0.5;
				float voroi23 = 0;
				float rest23 = 0;
				for( int it23 = 0; it23 <3; it23++ ){
				...
				voroi23 /= rest23;
				float temp_output_24_0 = pow( voroi23 , 7.02 );
				float4 temp_output_22_0 = ( lerpResult17 + temp_output_24_0 );
				
				float lerpResult25 = lerp( temp_output_30_0 , 0.0 , saturate( temp_output_20_0 ));
				...
				float Smoothness = ( lerpResult25 + temp_output_24_0 );
				float Occlusion = 1;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float time18 = 0.0;
				float2 voronoiSmoothId18 = 0;
				float2 texCoord15 = IN.ase_texcoord4.xy * float2( 2,1 ) + float2( 0,0 );
				float2 coords18 = texCoord15 * 13.41;
				float2 id18 = 0;
				float2 uv18 = 0;
				float fade18 = 0.5;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float time18 = 0.0;
				float2 voronoiSmoothId18 = 0;
				float2 texCoord15 = IN.ase_texcoord2.xy * float2( 2,1 ) + float2( 0,0 );
				float2 coords18 = texCoord15 * 13.41;
				float2 id18 = 0;
				float2 uv18 = 0;
				float fade18 = 0.5;
...
/*ASEBEGIN
Version=18935
41.33334;172.6667;1693.333;861;754.2164;520.6912;1.3;True;True
Node;AmplifyShaderEditor.RangedFloatNode;12;-340.6672,154.1666;Inherit;False;Property;_Smoothness;Smoothness;1;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;15;-1288.667,-260.8333;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;2,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;28;-322.2456,-15.73425;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;30;-598.8245,-569.1106;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.2;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;31;541.8836,-304.0245;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-338.6672,76.16667;Inherit;False;Property;_Metallic;Metallic;2;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;27;-332.2456,-272.7343;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;19;-677.2787,-292.6343;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;0.05;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;22;125.3397,-323.5985;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;21;-628.2787,-371.6344;Inherit;False;Constant;_Float0;Float 0;3;0;Create;True;0;0;0;False;0;False;-0.05;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.VoronoiNode;23;-247.8264,-641.0614;Inherit;True;0;0;1;3;3;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;38.81;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.PowerNode;24;-17.17334,-475.8537;Inherit;False;False;2;0;FLOAT;0.3;False;1;FLOAT;7.02;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;20;-457.2787,-356.6343;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;17;-169.9671,-290.6337;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;14;-951.6672,-293.8333;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;32;370.2835,-206.5245;Inherit;False;Property;_EmissionPower;Emission Power;3;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;25;-204.6915,-67.00623;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VoronoiNode;18;-906.8673,-549.9332;Inherit;True;0;0;1;1;3;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;13.41;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.SimpleAddOpNode;26;156.6833,-78.01999;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;11;-884.6667,-6.833347;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;1;[HDR];Create;True;0;0;0;False;0;False;-1;6142f97f1b22e93488087f2a43f931b3;6142f97f1b22e93488087f2a43f931b3;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=62B1435235FF45361431D9B3BBED64B630EC34A3
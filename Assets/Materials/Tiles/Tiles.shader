...
Shader "Tiles"
{
	Properties
	{
		...
		[ASEBegin]_Frequency("Frequency", Float) = 2
		_Tiling("Tiling", Vector) = (2,2,0,0)
		_Offset("Offset", Vector) = (0,0,0,0)
		_ActualColor("Actual Color", Color) = (0,0,0,0)
		_ActualColor2("Actual Color 2", Color) = (1,1,1,0)
		_Smoothness("Smoothness", Float) = 0.5
		_VoronoiPower("Voronoi Power", Float) = 0
		[ASEEnd]_VoronoiScale("Voronoi Scale", Float) = 100
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 temp_output_15_0_g5 = ( _Tiling * _Frequency );
				float2 break26_g5 = ( IN.ase_texcoord8.xy * temp_output_15_0_g5 );
				float2 appendResult27_g5 = (float2(( ( 0.0 * step( 1.0 , ( break26_g5.y % 2.0 ) ) ) + break26_g5.x ) , break26_g5.y));
				float2 break12_g5 = temp_output_15_0_g5;
				float temp_output_21_0_g5 = sign( ( break12_g5.y - break12_g5.x ) );
				float temp_output_14_0_g5 = 0.91;
				...
				float temp_output_23_0 = temp_output_2_0_g5;
				float4 lerpResult25 = lerp( _ActualColor , _ActualColor2 , temp_output_23_0);
				
				float time32 = 0.0;
				float2 voronoiSmoothId32 = 0;
				float2 texCoord15 = IN.ase_texcoord8.xy * _Tiling + _Offset;
				float2 coords32 = texCoord15 * _VoronoiScale;
				float2 id32 = 0;
				float2 uv32 = 0;
				float fade32 = 0.5;
				float voroi32 = 0;
				...
				float3 Albedo = lerpResult25.rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = saturate( ( ( temp_output_23_0 - _Smoothness ) + ( voroi32 * _VoronoiPower ) ) );
				float Occlusion = 1;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 temp_output_15_0_g5 = ( _Tiling * _Frequency );
				float2 break26_g5 = ( IN.ase_texcoord4.xy * temp_output_15_0_g5 );
				float2 appendResult27_g5 = (float2(( ( 0.0 * step( 1.0 , ( break26_g5.y % 2.0 ) ) ) + break26_g5.x ) , break26_g5.y));
				float2 break12_g5 = temp_output_15_0_g5;
				float temp_output_21_0_g5 = sign( ( break12_g5.y - break12_g5.x ) );
				float temp_output_14_0_g5 = 0.91;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 temp_output_15_0_g5 = ( _Tiling * _Frequency );
				float2 break26_g5 = ( IN.ase_texcoord2.xy * temp_output_15_0_g5 );
				float2 appendResult27_g5 = (float2(( ( 0.0 * step( 1.0 , ( break26_g5.y % 2.0 ) ) ) + break26_g5.x ) , break26_g5.y));
				float2 break12_g5 = temp_output_15_0_g5;
				float temp_output_21_0_g5 = sign( ( break12_g5.y - break12_g5.x ) );
				float temp_output_14_0_g5 = 0.91;
...
/*ASEBEGIN
Version=18935
311.3333;365.3333;1693.333;889.6667;655.6105;-406.6716;1;True;True
Node;AmplifyShaderEditor.FunctionNode;10;-511.6667,-37.83334;Inherit;True;Checkerboard;-1;;1;43dad715d66e03a4c8ad5f9564018081;0;4;1;FLOAT2;0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;FLOAT2;0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;26;287.3536,271.5205;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0.57;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;14;-787.6045,154.3601;Inherit;False;Property;_Frequency;Frequency;2;0;Create;True;0;0;0;False;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;35;371.3536,544.5205;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;27;152.3536,368.5205;Inherit;False;Property;_Smoothness;Smoothness;7;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;34;800.3536,404.5205;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;19;-157.6045,-216.6399;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;21;-439.6045,-194.6399;Inherit;False;Property;_ActualColor2;Actual Color 2;6;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;25;142.8555,30.82151;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;1,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.Vector2Node;16;-1016.704,-361.14;Inherit;False;Property;_Tiling;Tiling;3;0;Create;True;0;0;0;False;0;False;2,2;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.ColorNode;13;-985.1431,39.50115;Inherit;False;Property;_Color2;Color 2;1;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;15;-688.6045,-227.6399;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;23;-231.2997,157.9418;Inherit;True;Bricks Pattern;-1;;5;7d219d3a79fd53a48987a86fa91d6bac;0;4;15;FLOAT2;5,5;False;14;FLOAT;0.91;False;16;FLOAT;0;False;17;FLOAT2;0,1;False;2;FLOAT;0;FLOAT;3
Node;AmplifyShaderEditor.ColorNode;20;-431.6045,-367.6399;Inherit;False;Property;_ActualColor;Actual Color;5;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;17;-977.6045,-244.6399;Inherit;False;Property;_Offset;Offset;4;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleAddOpNode;33;556.3536,353.5205;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;37;-90.61047,614.3383;Inherit;False;Property;_VoronoiScale;Voronoi Scale;9;0;Create;True;0;0;0;False;0;False;100;100;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.VoronoiNode;32;87.35358,495.5205;Inherit;True;0;0;1;2;3;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;118.88;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.ColorNode;12;-1095.643,-143.7988;Inherit;False;Property;_Color;Color;0;0;Create;True;0;0;0;False;0;False;0.3679245,0.3679245,0.3679245,0;0.3679245,0.3679245,0.3679245,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;24;-481.0895,224.0338;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;36;257.3536,629.5205;Inherit;False;Property;_VoronoiPower;Voronoi Power;8;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=E485F5E30BD716F9038B7D1989EEE82397B875EC